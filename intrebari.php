...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="text-align:center;">
  <div class="container-fluid">
    <a class="navbar-brand" href="Home.php" ><img style="width:60%;" src="lg.png" id="id"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="font-size:2rem;">
        <li class="nav-item">
          <a class="nav-link "  aria-current="page" href="Home.php">Acasa</a>
        </li>
        <li class="nav-item active" >
          <a class="nav-link" style="color:#ff861c;" href="intrebari.php">Erori</a>
        </li>
        <li class="nav-item" >
...
<div class="pune" id="pune">
    ...
    <form action="erori.php" method="post">
...
<div class="frecvent"  id="element">
    <section >
        ...
        <details>
            <summary ><h1>Nu puteti sa va conectati cu prietenul</h1></summary>
            <h2> Aceata este din cauza serverului ,in acest caz trebuie sa reincarci pagina</h2>
        </details>
        <details>
            <summary ><h1>Probleme cu logarea</h1></summary>
            <h2>Problemele cu logarea nu sunt frecvent,dar si foarte greu de rozolvat.Daca intampinati aceasta problema trebuie sa ne precizati eroarea aceasta fiind preluata de catre noi si rezolvata in cel mai scurt timp
            <img style="width:95%;"src="raspuns.jpg"><img style="width:95%;"src="r1.png"></h2>
        </details>
    </section>
</div>
<script>
